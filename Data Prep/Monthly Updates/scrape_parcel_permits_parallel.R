...
# set some metadata for exporting results - MUST UPDATE
...
curr_xwalk_table <- paste0("dashboard.crosswalk_assessor_", curr_xwalk_year, "_", prev_xwalk_month, "_", curr_xwalk_month) 
