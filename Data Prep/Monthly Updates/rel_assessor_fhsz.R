...
#### Step 4: Join parcel data to local fire hazard zones data ####
st_crs(fhsz_local)
st_crs(parcels)
# right projections
...
#### Step 5: Join parcel data to state fire hazard zones data ####
st_crs(fhsz_state)
st_crs(parcels)
# right projections
...
#### Step 6: Join together the local and state fhsz joins ####
...
#### Step 7: Clean fire hazard join and push to postgres as relational table ####
...
#### STEP 8: Final column authority level ####
